 ...
 * mesma superfície que um cliente HTTP usa. Os quatro códigos de erro do
 * contrato são cobertos com mensagem exata em português, e a forma inválida
 * é recusada na borda, antes de alcançar o `Acervo`.
 */
