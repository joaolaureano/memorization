...
- **Requisitos funcionais**: 19. São 5 transversais reutilizados (FR-040,
  FR-042, FR-044, FR-045, FR-046) e 14 específicos (FR-070 a FR-083).
...
- **Limites propostos** (tamanhos, caracteres, revelação de duplicidade): estão
  em Assumptions como "a confirmar no clarify". Não são marcadores pendentes,
  porque há um padrão razoável.
